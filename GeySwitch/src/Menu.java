...
public class Menu extends JPanel implements KeyListener,ActionListener{
	...
	public void oyuncuYarat()
	{
		...
		{
			if (i==0) {t = 67; g=Color.BLACK;}
			if (i==1) {t = 77; g=Color.BLUE;}
			if (i==2) {t = 17; g=Color.GREEN;}
			if (i==3) {t = 39; g=Color.RED;}
			if (i==4) {t = 65; g=Color.CYAN;}
			if (i==5) {t = 99; g=Color.MAGENTA;}
			if (i==6) {t = 76; g=Color.YELLOW;}
			p[i]=new Player(t,20,(75+75 *i),40,40,g);
		}
		oyuncusayisi=2;
	}
	@Override
